...
# 零申报 Sheet: 正常工资薪金所得 30 列 (与 normal_salary.py 一致), 仅 本期收入+五险一金 填 0
...
def generate_compare_excel(add_rows, departed_rows, pending_rows, stats, output_dir: str, pay_month: int,
    ...
    add_explanation_sheet(wb, [
        ...
        ("零申报", [
            "个税端在职且无发薪、未判定为离职/待确认的人员，按正常工资薪金所得 30 列格式输出，本期收入及养老/医疗/失业/公积金填 0，其余列留空供零申报。",
