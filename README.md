...
```
左 = 本期收入 - 养老个人 - 失业个人 - 医疗个人 - 公积金个人 - 其他调整 - 扣款大病险 - 意外险
右 = (实发工资 - 经济补偿金) + 税后扣除工会会费 + 个人承担代理费 + 个人所得税 - 免税
通过 = |左 - 右| < 0.01
```
...
- 经济补偿金(ATC93M) 属一次性补偿收入，含在实发金额中但不参与正常工资薪金验算，故从实发中扣回；验证报告另按 3×年平均工资（默认 12 万，UI 可配置）判断是否达交税标准
